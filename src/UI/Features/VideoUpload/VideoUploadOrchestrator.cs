...
public sealed class VideoUploadOrchestrator
{
        ...
        IConfiguration configuration)
    {
        ...
        _imageQuality = configuration.GetValue("VideoUpload:ImageQuality", defaultValue: 1.0);
        _shouldCleanupFrames = configuration.GetValue("VideoUpload:ShouldCleanupFrames", defaultValue: true);
    }
