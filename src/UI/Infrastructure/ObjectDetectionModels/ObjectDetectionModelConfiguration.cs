...
/// </summary>
public sealed class ObjectDetectionModelConfiguration
{
    public const string ConfigurationSectionName = "ObjectDetectionModels";
...
public sealed class ValidateObjectDetectionModelOptions : IValidateOptions<ObjectDetectionModelConfiguration>
{
    public ValidateOptionsResult Validate(string? name, ObjectDetectionModelConfiguration modelConfiguration)
    {
        StringBuilder failuresBuilder = new();
        TinyYoloV3ModelConfig tinyYoloV3ModelConfig = modelConfiguration.TinyYoloV3;
